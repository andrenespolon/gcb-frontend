...
class Cadastro extends Component {
    ...
    cadastraMedico = async (e) => {
        ...
        try {
            const res = await api.post('/gcb/api/v1/cadastro', newMedico);
            if (res.status == 201) {
    ...
    render() {
        let isEnabled = (this.state.nome.length > 0 && this.state.sobrenome.length > 0 && this.state.ddd.length > 0 && this.state.telefone.length > 0);
        return(
            <div className="cadastro">
                <div className="row">
                    <label>Cadastro de Médico</label>
                    <form className="form">
                        ...
                        <div className="form-group">
                            <input type="text" placeholder="DDD. Ex: 13" required
                        ...
                        <div className="form-group">
                            ...
                            disabled={!isEnabled}>CADASTRAR</button>
                        </div>                        
                    </form>
                </div>
            </div>
